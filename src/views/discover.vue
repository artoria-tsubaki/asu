            ...
            <a id="btn">
                ...
                <b class="btn-text">
                    <svg t="1668930804988" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="6309" width="200" height="200">
                        <path d="M740.863479 475.644354l-68.544456-68.544456-12.917192-12.917192 12.917192-12.917192 25.626043-25.626043 12.917192-12.917192 12.917193 12.917192 143.547507 143.547508 12.917193 12.917192-12.917193 12.917192-143.547507 143.547508-12.917193 12.917192-12.917192-12.917192-25.626043-25.626043-12.917192-12.917192 12.917192-12.917192 68.544456-68.544456H127.921872v-72.711292l612.941607-0.208342z" fill="#000" p-id="6310"></path>
                        <path d="M740.863479 475.644354l-68.544456-68.544456-12.917192-12.917192 12.917192-12.70885 25.626043-25.834385 12.917192-12.917192 12.917193 12.917192 143.339165 143.547508 12.917193 12.917192-12.917193 12.70885-143.339165 143.547508-12.917193 12.917192-12.917192-12.917192-25.626043-25.626043-12.917192-12.917192 12.917192-12.917192 68.544456-68.544456 28.959512-36.251475z" fill="#000" p-id="6311"></path>
                    </svg>
                </b>
            </a>    
        </div>
...
<script setup lang="ts">
    ...
    const menuItemMouseEnterHandler = (e: Event) => {
        ...
        cursorAnimation(cursor, title)
    }
    const debounceMouseEnterHandler = menuItemMouseEnterHandler

    const cursorAnimation = (cursor: HTMLElement, title: HTMLElement) => {
        let t = setInterval(() => animation(), 10)
        let process = 0
        cursor.style.display = 'block'
        const animation = () => {
            console.log(process)
            process++
            // title.style.transform = `translate3d(${scale(process, 0, 100, 0, 13.2)}px, 0px, 0px)`
            if(process > 99) {
                clearInterval(t)
                cursor.style.transform = `matrix(1, 0, 0, 1, 0, 0)`
                return
            }
            cursor.style.transform = `translate3d(0px, 0px, 0px) scale(${scale(process, 0, 100, 0, 1.5)}, 1)`
        }
    }
